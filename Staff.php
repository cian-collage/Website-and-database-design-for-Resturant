<!-- 
    Description: 
    This is the staff account page. 
    It gives the staff member the ability to view  2 tables (menu and Reservations)
    The staff member can also add,edit and delete items from the menu table.
-->
...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            var contents = document.querySelectorAll('.menu,.reservations,.add,.delete,.edit');
